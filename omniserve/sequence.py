...
from omniserve.block import LogicalTokenBlock
from omniserve.prefix import Prefix
...
class Sequence:
    ...
    def __init__(
        ...
        self.full_prompt_token_ids = prompt_token_ids
        if full_prompt_token_ids is not None:
            self.full_prompt_token_ids = full_prompt_token_ids  # NOTE(Shang): This is for decoding simulation, so that the original prompt could be omit during the printing
...
class SequenceGroupMetadata:
    ...
    def __init__(
        ...
        streaming_block_tables: Dict[int, List[int]],
        prefix: Optional[Prefix] = None,
    ) -> None:
        self.request_id = request_id
