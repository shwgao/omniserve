...
# def get_env_params(params_name: str, required: bool=True):
#     if required:
#         assert params_name in os.environ, f"{params_name} should be given!"
#     params_value = os.environ.get(params_name)
#     return params_value