                                     ...
                                     )
{
    ...
    float *kv_scale_orig_quant_ptr = kv_scale_orig_quant.data_ptr<float>();
    ...
    KVBlockArray<false> retrievalkvTable(batch_size, retrieval_max_blocks_per_seq, tokens_per_block, size_per_retrieval_token, 0, 0, 0, 0, 0, 0);
    ...
    invokeApplyBiasRopeUpdateKVCache<half, KVBlockArray<false>, KVBlockArray<true>, false>(
        ...
        qkv_bias_ptr, kv_scale_orig_quant_ptr, retrieval_seq_lens_ptr, retrieval_kv_seq_lens_ptr,
