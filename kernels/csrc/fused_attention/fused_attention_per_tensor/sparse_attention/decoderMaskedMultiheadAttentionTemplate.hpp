...
#pragma unroll
    ...
    inline __device__ void masked_multihead_attention_kernel(
        ...
        // printf("kv_scale_orig_quant[0]: %f, kv_scale_orig_quant[1]: %f, kv_scale_quant_orig[0]: %f, kv_scale_quant_orig[1]: %f \n", params.kv_scale_orig_quant[0], params.kv_scale_orig_quant[1], params.kv_scale_quant_orig[0], params.kv_scale_quant_orig[1]);
